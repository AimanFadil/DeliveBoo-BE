                        ...
                        <div class="card border-success-subtle border-2 ">
                            ...
                            <div class="card-body bg-forms">
                                <form method="POST" action="{{ route('restaurants.store') }}"enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="vat_number" type="vat_number" min="11" max="11"
                                                ...
                                                name="vat_number" required autocomplete="new-vat_number">
                                    ...
                                    <div class="mb-4 row">
                                        <label for="vat_number"
                                            class="col-md-4 col-form-label text-md-right">{{ __('Logo') }}
                                        </label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        @foreach ($typologies as $typology)
                                            <div class="form-check-inline ">
                                                <div class="d-flex ">
                                                    <input type="checkbox" name="typology[]"
                                                        id="typology-{{ $typology->id }}" class=" input-checkbox m-0"
                                                        value="{{ $typology->id }}" @checked(is_array(old('typology')) && in_array($typology->id, old('typology')))>
                                                    <label for=""
